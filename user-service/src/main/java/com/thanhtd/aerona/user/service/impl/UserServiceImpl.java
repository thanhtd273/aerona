...
import com.thanhtd.aerona.user.dao.UserDao;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User findByUserId(String userId) throws LogicException {
    ...
    @Override
    @Transactional
    public User updateUser(String userId, UserInfo userInfo) throws LogicException {
        if (ObjectUtils.isEmpty(userInfo))
            throw new LogicException(ErrorCode.DATA_NULL);
    ...
    @Override
    public ErrorCode deactivateUser(String userId) throws LogicException {
        User user = findByUserId(userId);
        if (ObjectUtils.isEmpty(user))
    ...
    private void saveUserRoles(String userId, String roleStr) throws LogicException {
